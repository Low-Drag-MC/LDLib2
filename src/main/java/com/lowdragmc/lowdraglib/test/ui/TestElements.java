...
public class TestElements implements IUITest {
    ...
    public ModularUI createUI(Player entityPlayer) {
        ...
        root.setBackgroundTexture(ResourceBorderTexture.BORDERED_BACKGROUND);
        root.addChild(new UIElement()
                .layout(layout -> {
                    layout.setFlex(1);
                    layout.setGap(YogaGutter.ROW, 10);
                }).setId("container")
                .setBackgroundTexture(ResourceBorderTexture.BORDERED_BACKGROUND)
