...
public class Sprites {
    ...
    public static SpriteTexture BORDER_TRANSLATE = SpriteTexture.of(GDP).setSprite(86, 165, 16, 16).setBorder(5, 5, 5, 5);
    ...
    public static SpriteTexture BORDER_RT0_TRANSLATE = SpriteTexture.of(GDP).setSprite(103, 165, 16, 16).setBorder(5, 5, 5, 5);
    ...
    public static SpriteTexture BORDER_RT1_TRANSLATE = SpriteTexture.of(GDP).setSprite(120, 165, 16, 16).setBorder(5, 5, 5, 5);
    ...
    public static SpriteTexture BORDER_RT2_TRANSLATE = SpriteTexture.of(GDP).setSprite(137, 165, 16, 16).setBorder(5, 5, 5, 5);
    ...
    public static SpriteTexture BORDER_RT3_TRANSLATE = SpriteTexture.of(GDP).setSprite(154, 165, 16, 16).setBorder(5, 5, 5, 5);
    ...
    public static SpriteTexture BORDER1_TRANSLATE = SpriteTexture.of(GDP).setSprite(86, 239, 16, 16).setBorder(5, 5, 5, 5);
    ...
    public static SpriteTexture BORDER1_RT0_TRANSLATE = SpriteTexture.of(GDP).setSprite(103, 239, 16, 16).setBorder(5, 5, 5, 5);
    ...
    public static SpriteTexture BORDER1_RT1_TRANSLATE = SpriteTexture.of(GDP).setSprite(120, 165, 16, 16).setBorder(5, 5, 5, 5);
    ...
    public static SpriteTexture BORDER1_RT2_TRANSLATE = SpriteTexture.of(GDP).setSprite(137, 239, 16, 16).setBorder(5, 5, 5, 5);
