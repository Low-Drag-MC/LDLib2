...
public abstract class ModularEmiRecipe<T extends Widget> implements EmiRecipe {
        ...
        for (Widget w : getFlatWidgetCollection(widget)) {
            if (w instanceof IRecipeIngredientSlot slot) {
                ...
                if (io != null && io != IngredientIO.RENDER_ONLY) {
                    ...
                    if (slot instanceof com.lowdragmc.lowdraglib2.gui.widget.SlotWidget slotW) {
                        clearSlotWidgetHandler(slotW, 0);
                    } else if (slot instanceof com.lowdragmc.lowdraglib2.gui.widget.TankWidget tankW) {
    ...
    public void clearSlotWidgetHandler(com.lowdragmc.lowdraglib2.gui.widget.SlotWidget slotW, int slotIndex) {
    ...
    public void clearTankWidgetHandler(com.lowdragmc.lowdraglib2.gui.widget.TankWidget tankW) {
