...
@LDLRegisterClient(name = "fluid_stack", registry = "ldlib2:configurator_accessor")
public class FluidStackAccessor extends TypesAccessor<FluidStack> {
    ...
    public Configurator create(String name, Supplier<FluidStack> supplier, Consumer<FluidStack> consumer, boolean forceUpdate, Field field) {
        ...
        group.addConfigurators(new com.lowdragmc.lowdraglib2.editor_outdated.configurator.NumberConfigurator("ldlib.gui.editor.configurator.amount",
