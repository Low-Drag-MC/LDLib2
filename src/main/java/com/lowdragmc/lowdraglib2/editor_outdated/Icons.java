...
public class Icons {
    ...
    public static ResourceTexture LEFT = new ResourceTexture("ldlib2:textures/gui/left.png");
    public static ResourceTexture UP = new ResourceTexture("ldlib2:textures/gui/up.png");
    public static ResourceTexture DOWN = new ResourceTexture("ldlib2:textures/gui/down.png");
    public static ResourceTexture RIGHT = new ResourceTexture("ldlib2:textures/gui/right.png");
