...
public final class MPGameTests {
    ...
    public static void init(IEventBus eventBus) {
        ...
        initialized = true;
        MPScenarioDistLoadingTest.registerFunctions();
        TEST_FUNCTIONS.register(eventBus);
        eventBus.addListener(MPGameTests::registerGameTests);
    }
    ...
    private static void registerGameTests(RegisterGameTestsEvent event) {
        ...
        MPScenarioDistLoadingTest.register(event, environment);
    }
