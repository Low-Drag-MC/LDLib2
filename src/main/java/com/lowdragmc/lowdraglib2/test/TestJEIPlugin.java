...
import com.lowdragmc.lowdraglib2.integration.jei.ModularUIRecipeCategory;
...
public class TestJEIPlugin {
    ...
    private static class TestJEIRecipeCategory extends ModularUIRecipeCategory<TestJEIRecipe> {
        private static RecipeType<TestJEIRecipe> RECIPE_TYPE = new RecipeType<>(LDLib2.id("test_category"), TestJEIRecipe.class);
