...
public interface ObjGeometryAccessor {
    @Invoker
    Pair<BakedQuad, Direction> invokeMakeQuad(int[][] indices, int tintIndex, Vector4f colorTint, Vector4f ambientColor, BakedQuad.SpriteInfo texture, Transformation transform);
}
