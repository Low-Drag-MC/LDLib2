...
public class WindowDragHelper {
    ...
    public static void drawResizeIcon(GUIContext context, UIElement element, float padding) {
        drawResizeIcon(context, element, padding, EnumSet.allOf(ResizeHandle.class));
    }

    public static void drawResizeIcon(GUIContext context, UIElement element, float padding, Set<ResizeHandle> allowedHandles) {
        var handle = WindowDragHelper.detectResizeHandle(element, context.mouseX, context.mouseY, padding, allowedHandles);
