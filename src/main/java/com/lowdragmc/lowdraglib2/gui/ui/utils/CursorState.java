 ...
 * operating system — {@code MouseHandler#getScaledXPos/getScaledYPos}, and therefore the
 * {@code mouseX}/{@code mouseY} every {@code Screen#render} receives, and therefore
