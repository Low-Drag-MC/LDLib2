...
//            mask = MASK_POOL.poll();
//            if (mask == null) {
//                mask = new TextureTarget(width, height, false, false);
//            }
//        }
...
//    }
//
//    public void bind(GUIContext context) {
//        ensureTargetValid(context.mc.getMainRenderTarget().width, context.mc.getMainRenderTarget().height);
//        assert target != null;
//
...
//    }
//
//    private void drawMask(GUIContext context, IGuiTexture maskTexture) {
//        assert target != null;
...
//            context.drawTexture(maskTexture, x, y, width, height);
...
//        var pose = context.pose.last().pose();
