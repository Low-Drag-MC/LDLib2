...
@LDLRegister(name = "command", group = "graph_processor.node.minecraft", registry = "ldlib2:graph_node")
        ...
        if (this.command != null) {
            ...
            if (minecraftServer.isCommandBlockEnabled() && !StringUtil.isNullOrEmpty(this.command)) {
                try {
                    ...
                    LDLib2.LOGGER.error("Error while executing command: {}", this.command, var6);
                }
            }
        }
    }
