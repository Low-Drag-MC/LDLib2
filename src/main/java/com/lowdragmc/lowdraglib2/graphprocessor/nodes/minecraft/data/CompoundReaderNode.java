...
import com.lowdragmc.lowdraglib2.editor_outdated.configurator.StringConfigurator;
...
@LDLRegister(name = "compound reader", group = "graph_processor.node.minecraft.data", registry = "ldlib2:graph_node")
