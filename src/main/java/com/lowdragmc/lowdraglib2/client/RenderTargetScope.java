 ...
 * </ul>
 *
 * <p>"Where drawing goes" is not a bound framebuffer object but the pair of output texture
...
public final class RenderTargetScope implements Scope {
    ...
    public void close() {
        RenderSystem.outputColorTextureOverride = color;
        RenderSystem.outputDepthTextureOverride = depth;
        // Deliberately no glViewport here. The viewport is owned per render pass —
