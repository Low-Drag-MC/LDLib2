...
public final class LDFontStatsOverlay implements ModularHudLayer {
    ...
    /**
     * More render types than this means the text is costing several draw calls, which is worth a second look.
     */
    private static final int RENDER_TYPE_WARN_THRESHOLD = 4;
    ...
    private ModularUI buildUI() {
        ...
        row(panel, () -> snapshot.renderTypes() > RENDER_TYPE_WARN_THRESHOLD ? WARN_COLOR : VALUE_COLOR,
                () -> "draw calls (render types)  " + snapshot.renderTypes());
